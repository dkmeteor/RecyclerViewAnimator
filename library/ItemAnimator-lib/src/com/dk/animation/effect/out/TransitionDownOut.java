...
public class TransitionDownOut extends SegmentAnimator {
    ...
    public void startAnimation(final ViewHolder holder, long duration, final BaseItemAnimator animator) {
        ...
        ViewCompat.animate(view).translationX(0).translationY(ViewUtils.getScreenHeight()).setDuration(duration).setStartDelay(mDelayCount * mDelay).setListener(new VpaListenerAdapter() {
            @Override
