...
public class AlphaOut extends SegmentAnimator {
    @Override
    ...
    public void startAnimation(final ViewHolder holder, long duration, final BaseItemAnimator animator) {
        ...
        ViewCompat.animate(holder.itemView).alpha(0f).setDuration(duration).setStartDelay(mDelayCount * mDelay).setListener(new VpaListenerAdapter() {
            @Override
