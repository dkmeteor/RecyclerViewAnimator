...
public class AnchorJumpAnimator extends BaseItemAnimator {
	...
	public AnchorJumpAnimator(RecyclerView recyclerView, View anchor) {
		super(recyclerView);
		mAnchor = anchor;
		setMoveDuration(300);
		setAddDuration(300);
	...
	public AnchorJumpAnimator(RecyclerView recyclerView) {
		super(recyclerView);
		setMoveDuration(300);
		setAddDuration(300);
		setRemoveDuration(300);
