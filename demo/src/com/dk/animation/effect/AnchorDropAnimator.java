...
public class AnchorDropAnimator extends BaseItemAnimator {
	...
	public AnchorDropAnimator(RecyclerView recyclerView, View anchor) {
		super(recyclerView);
		mAnchor = anchor;
		setMoveDuration(300);
		setAddDuration(300);
	...
	public AnchorDropAnimator(RecyclerView recyclerView) {
		super(recyclerView);
		setMoveDuration(300);
		setAddDuration(300);
		setRemoveDuration(300);
	...
	protected void prepareAnimateAdd(RecyclerView.ViewHolder holder) {
		...
		mDelayCount = 0;
		System.out.println("prepareAnimateAdd");
	}

	protected void animateAddImpl(final RecyclerView.ViewHolder holder) {

		System.out.println("animateAddImpl");
		final View view = holder.itemView;
