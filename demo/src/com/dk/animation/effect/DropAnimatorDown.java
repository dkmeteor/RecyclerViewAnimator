...
public class DropAnimatorDown extends BaseItemAnimator {
	...
	public DropAnimatorDown(RecyclerView recyclerView, View anchor) {
		super(recyclerView);
		mAnchor = anchor;
		setMoveDuration(300);
		setAddDuration(300);
	...
	public DropAnimatorDown(RecyclerView recyclerView) {
		super(recyclerView);
		setMoveDuration(300);
		setAddDuration(300);
		setRemoveDuration(300);
