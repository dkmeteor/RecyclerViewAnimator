...
public class ProgressActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAnimator = new PackageAnimator(new AnchorDropIn(findViewById(R.id.refresh)), new AnchorDropOut(findViewById(R.id.trash)));
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                mAnimator = new PackageAnimator(null, new AnchorDropOut(findViewById(R.id.trash)));
                mAnimator.setAddDuration(800);
                mRecyclerView.setItemAnimator(mAnimator);
        ...
        findViewById(R.id.trash).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mAnimator = new PackageAnimator(new AnchorDropIn(findViewById(R.id.trash)), new AnchorDropOut(findViewById(R.id.trash)));
                ...
                mRecyclerView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ViewUtils.disableScroll(mRecyclerView, 800 + 800 + 200 * 3);
    ...
    private void removeItem(int position) {
        ...
        mAdapter.disableEventForAniamtion(800 + 800);
        ViewUtils.disableScroll(mRecyclerView, 800 + 800);
    }
