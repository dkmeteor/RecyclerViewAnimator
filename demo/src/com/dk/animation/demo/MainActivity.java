...
//                        ViewUtils.disableScroll(mRecyclerView.getRefreshableView(), 800 + 200 * 3);
                    }
                }, 200);
            ...
            public void onPullUpToRefresh(PullToRefreshBase refreshView) {
                ...
                mRecyclerView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ViewUtils.disableScroll(mRecyclerView.getRefreshableView(), 800+800 + 200 * 5);
                    }
                }, 200);
    ...
    private void removeItem(int position) {
        ...
        ViewUtils.disableScroll(mRecyclerView.getRefreshableView(), 800 +800+ 200 * 0);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_flip_horizon:
            mAnimator = new PackageAnimator(new FlipHorizonIn(), new FlipXOut());
            mRecyclerView.getRefreshableView().setItemAnimator(mAnimator);

            break;
        case R.id.action_flip_vertial:
            mAnimator = new PackageAnimator(new FlipVertialIn(), new FlipYOut());
            mRecyclerView.getRefreshableView().setItemAnimator(mAnimator);
            break;
